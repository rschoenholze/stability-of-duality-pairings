...
np.save('d{d}l{l}_minEV_unstr'.format(d=2,l=1),minEV)
#np.save('/cluster/home/rschoenholze/Bsc_Thesis/unstructured/d{d}l{l}_minEV_unstr'.format(d=2,l=1),minEV)
...
for j in range(lowest_low_order, highest_low_order):
    ...
    plt.legend()
    plt.savefig("d2l1_minEV_unstr.pdf")
    #plt.savefig("/cluster/home/rschoenholze/Bsc_Thesis/unstructured/d2l1_minEV_unstr.pdf")
