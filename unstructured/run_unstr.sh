...
# python3 d2l0_unstr.py | tee -a exp.data
echo "=================== d=3, l=0 =======================" | tee -a exp.data
python3 d3l0_unstr.py | tee -a exp.data

# echo "=================== d=2, l=1 =======================" | tee -a exp.data
# python3 d2l1_unstr.py | tee -a exp.data

# echo "=================== d=2, l=2 =======================" | tee -a exp.data
# python3 d2l2_unstr.py | tee -a exp.data
# echo "=================== d=3, l=3 =======================" | tee -a exp.data
# python3 d3l3_unstr.py | tee -a exp.data

echo "=================== d=3, l=1 =======================" | tee -a exp.data
python3 d3l1_unstr.py | tee -a exp.data
echo "=================== d=3, l=2 =======================" | tee -a exp.data
python3 d3l2_unstr.py | tee -a exp.data
