...
np.save('/cluster/home/rschoenholze/Bsc_Thesis/2 unstructured/d{d}l{l}_minEV_unstr'.format(d=3,l=0),minEV)
...
#     plt.savefig("/cluster/home/rschoenholze/Bsc_Thesis/2 unstructured/d3l0_minEV_unstr.pdf" )
